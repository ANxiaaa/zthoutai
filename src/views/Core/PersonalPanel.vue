<template>
  <div class="personal-panel">
    ...
    <div class="main-operation">
        ...
        <span class="main-operation-item">
          <el-button size="small" icon="fa fa-key" @click="updatePwd"> 修改密码</el-button>
        </span>    
    </div>
    <div class="other-operation">
        ...
        <div class="other-operation-item">
          <li class="fa fa-undo" @click="showBackupDialog"></li>
...
import updatePwd from "@/views/comm/updatePwd"
export default {
  name: 'PersonalPanel',
  components:{
    Backup,
  ...
  methods: {
    ...
    updatePwd: function() {
      this.$refs.updatePwdDialog.setUpdatePwdVisible(true)
    }
  },
  mounted() {
  }
